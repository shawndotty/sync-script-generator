export default {
	...
	GENERATOR_VIEW_BTN_SAVE_PRESET: "儲存預設",
	GENERATOR_VIEW_BTN_GENERATE: "產生同步腳本",
	GENERATOR_VIEW_BTN_ADD_FOLDER: "新增資料夾設定",
	GENERATOR_VIEW_FOLDER_PATH_NAME: "資料夾路徑",
	GENERATOR_VIEW_FOLDER_PATH_DESC: "您想要同步的資料夾路徑。",
	GENERATOR_VIEW_FOLDER_PATH_EXAMPLE: "範例: MyVault/Projects/Active",
	GENERATOR_VIEW_BTN_BROWSE: "瀏覽",
	GENERATOR_VIEW_TOOLTIP_EDIT_OBJECT: "編輯物件",
	GENERATOR_VIEW_TOOLTIP_EDIT_ARRAY: "編輯陣列",
	GENERATOR_VIEW_DESC_TITLE: "說明",
	GENERATOR_VIEW_EXAMPLE_USAGE_TITLE: "範例/用法:",
	GENERATOR_VIEW_DESC_PLACEHOLDER: "選擇一個設定項以在此處檢視說明。",
	GENERATOR_VIEW_NOTICE_IMPORTED: "已從 ${file} 匯入設定",
	GENERATOR_VIEW_NOTICE_NO_PLATFORM: "無法在範本中偵測到平台。",
	GENERATOR_VIEW_NOTICE_NO_DEFAULT: "未為此平台設定預設範本。",
	GENERATOR_VIEW_NOTICE_TEMPLATE_NOT_FOUND: "找不到範本檔案: ${path}",
	GENERATOR_VIEW_NOTICE_LOAD_FAILED: "載入預設範本失敗: ${error}",
	...
	GENERATOR_VIEW_GROUP_ADVANCED: "進階",
	GENERATOR_VIEW_GROUP_EXTRACT: "提取",
	GENERATOR_VIEW_GROUP_OTHER: "其他",
	GENERATOR_VIEW_TAB_ROOT: "根",
	GENERATOR_VIEW_TAB_VAULT: "庫",
	GENERATOR_VIEW_TAB_FOLDER: "資料夾",

	// Fetch Generator View
	FETCH_GENERATOR_VIEW_TITLE: "Fetch腳本產生器",
	FETCH_GENERATOR_VIEW_PLATFORMS_TITLE: "平台",
	FETCH_GENERATOR_VIEW_SETTINGS_TITLE_SUFFIX: "Fetch設定",
	FETCH_GENERATOR_VIEW_BTN_IMPORT_TEMPLATE: "匯入範本",
	FETCH_GENERATOR_VIEW_BTN_LOAD_DEFAULT: "載入預設範本",
	FETCH_GENERATOR_VIEW_BTN_PRESETS: "載入預設",
	FETCH_GENERATOR_VIEW_BTN_SAVE_PRESET: "儲存預設",
	FETCH_GENERATOR_VIEW_BTN_GENERATE: "生成腳本",
	FETCH_GENERATOR_VIEW_TAB_ROOT: "根",
	FETCH_GENERATOR_VIEW_TAB_FOLDER: "資料夾",
	...
	FETCH_GENERATOR_VIEW_TARGET_FOLDER_DESC:
		"您想要獲取數據到的目標資料夾路徑。",
	FETCH_GENERATOR_VIEW_TARGET_FOLDER_EXAMPLE: "範例: MyVault/Projects/Active",
	FETCH_GENERATOR_VIEW_BTN_BROWSE: "瀏覽",
	FETCH_GENERATOR_VIEW_DESC_TITLE: "說明",
	FETCH_GENERATOR_VIEW_EXAMPLE_USAGE_TITLE: "範例/用法:",
	FETCH_GENERATOR_VIEW_DESC_PLACEHOLDER: "選擇一個設定項以在此處檢視說明。",
	FETCH_GENERATOR_VIEW_NOTICE_IMPORTED: "已從 ${file} 匯入設定",
	FETCH_GENERATOR_VIEW_NOTICE_NO_PLATFORM: "無法在範本中偵測到平台。",
	FETCH_GENERATOR_VIEW_NOTICE_NO_DEFAULT: "未為此平台設定預設範本。",
	FETCH_GENERATOR_VIEW_NOTICE_TEMPLATE_NOT_FOUND: "找不到範本檔案: ${path}",
	FETCH_GENERATOR_VIEW_NOTICE_LOAD_FAILED: "載入預設範本失敗: ${error}",
	...
	OBJECT_EDIT_EMPTY_STATE: "無條目。點擊「新增條目」開始。",
	...
	ARRAY_EDIT_EMPTY_STATE: "無條目。點擊「新增項目」開始。",
	...
	PRESET_MANAGER_SAVE_TITLE: "儲存目前配置",
	...
	FETCH_PRESET_MANAGER_NOTICE_LOADED: '已載入預設 "${name}"',
	...
	SETTINGS_DEFAULT_SYNC_TEMPLATES_TITLE: "預設同步範本",
	SETTINGS_DEFAULT_SYNC_TEMPLATES_DESC:
		"為每個平台設定預設範本檔案。匯入配置時將使用這些範本。",
	SETTINGS_DEFAULT_TEMPLATE_NAME: "${platform} 預設範本",
	SETTINGS_DEFAULT_TEMPLATE_DESC: "${platform} 平台的預設範本檔案路徑",
	SETTINGS_DEFAULT_TEMPLATE_PLACEHOLDER: "未選擇範本",
	SETTINGS_BTN_BROWSE: "瀏覽",
	SETTINGS_TOOLTIP_CLEAR: "清除",
	SETTINGS_DEFAULT_FETCH_TEMPLATES_TITLE: "預設 Fetch 範本",
	SETTINGS_DEFAULT_FETCH_TEMPLATES_DESC:
		"為每個平台設定預設 Fetch 範本檔案。匯入 Fetch 配置時將使用這些範本。",
	SETTINGS_DEFAULT_FETCH_TEMPLATE_NAME: "${platform} 預設 Fetch 範本",
	SETTINGS_DEFAULT_FETCH_TEMPLATE_DESC:
		"${platform} 平台的預設 Fetch 範本檔案路徑",

	// Main
	MAIN_RIBBON_SYNC: "同步腳本產生器",
	MAIN_RIBBON_FETCH: "Fetch 腳本產生器",
	MAIN_CMD_OPEN_SYNC: "開啟同步腳本產生器",
	MAIN_CMD_OPEN_FETCH: "開啟 Fetch 腳本產生器",
};
